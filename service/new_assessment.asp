...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="main_content_table">
  ...
  <tr>
    <td class="maincontent"><h1>Yamaha Technician Accreditation Program</h1>
      <h2>Please select the number that best reflects your current experience</h2>
      <p><strong>5 - Expert</strong><br>
      You have a great deal of experience in the subject and apply those skills to your work and you are able to teach the subject to others in depth.</p>
      <p><strong>4 - Advanced</strong><br>
      You have a thorough understanding of the subject and apply those principles in your work.</p>
      <p><strong>3 - Intermediate</strong><br>
      Have an understanding of the subject and apply it in your work but may occassionally require support from others.</p>
      <p><strong>2 - New</strong></p>
      <p><strong>1 - Basic</strong><br>
        You are new to or unfamiliar with the subject and carry out repair work under instruction.
      </p>
      ...
      <form action="" method="post" name="form_add" id="form_add" onsubmit="return validateFormOnSubmit(this)">        
        <table width="800" border="0" cellspacing="0" cellpadding="8">
          ...
          <tr>
            <td>2. Understand the limitations for each product based on their specifications and can test to them to confirm</td>
          ...
          <tr>
            <td>3. Have and use a a defined procedure for dealing with <em>&quot;No Fault Found&quot;</em> cases</td>
          ...
          <tr>
            <td>7. Able to trace and diagnose faults down to the specific circuit board</td>
          ...
          <tr>
            <td colspan="6"><h3>Section 2</h3></td>
          </tr>
          <tr>
            <td>8. Understand router configuration and set up a home network</td>
          ...
          <tr>
            <td>9. Know how to disassemble and re-assemble most Yamaha products</td>
          ...
          <tr>
            <td>11. Have knowledge of common repair issues with Yamaha and apply them</td>
          ...
          <tr>
            <td>13. Can understand and trace a fault using block diagram</td>
          ...
          <tr>
            <td>18. Understand schematic/circuit diagrams and how the circuits work</td>
          ...
          <tr>
            <td colspan="6"><h3>Section 3</h3></td>
          </tr>
          <tr>
            <td>19. Able to secure cables and fix them to prevent vibration or interference</td>
          ...
          <tr>
            <td>25. Can locate spare parts in the service manual and order them using the correct part number</td>
