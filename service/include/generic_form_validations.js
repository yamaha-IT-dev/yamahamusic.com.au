...
function validateDate(fld){
	//var dt=document.form_add_request.txtDateReceived
...
function validateClassDate(fld) {
    var error = "";
    ...
    if (isDate(fld.value) == false) {
        fld.style.background = 'Yellow'; 
        error = "- Date must be in DD/MM/YYYY.\n"
	} else if (transfer_date < today) {
        fld.style.background = 'Yellow';
        error = "- Date must be greater than todays date.\n";		
    } else {
        fld.style.background = 'White';
    }
    return error;  
