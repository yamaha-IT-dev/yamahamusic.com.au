...
function addPremiumCustomer
    ...
    if CheckForSQLError(conn,"Add",MessageText) = TRUE then
		...
		Set JMail=CreateObject("JMail.SMTPMail")
			...
			& "" & vbCrLf _
			& "Once you have received your tuning e-voucher, please contact the piano dealer from whom you purchased your piano to organise your first in-home tuning. Alternatively, you can visit http://au.yamaha.com/en/service_centers/ to locate your Yamaha Accredited Service Agent. The Yamaha Accredited Service Agent who performs this first in-home tuning will require you to provide the tuning e-voucher at the time of the visit so it is important to print this voucher off and keep it in a safe place." & vbCrLf _
			& "" & vbCrLf _
		...
		if session("cashback") = "1" then
			call sendCashbackEmail(session("email"))
			Response.Redirect("../summercashback/upload.asp")
		else					
...
function sendCashbackEmail(strEmail)
	Set JMail=CreateObject("JMail.SMTPMail")
		
		JMail.ServerAddress = "smtp.bne.server-mail.com"
		JMail.Subject		= "Yamaha Piano Summer Factory Cashback Registration"
		JMail.Sender		= "eric.ong@music.yamaha.com"
		JMail.SenderName	= "Yamaha Music Australia"
		JMail.AddRecipient (strEmail)
		JMail.Body = "Dear Customer," & vbCrLf _
		& "" & vbCrLf _
		& "Congratulations on your new Yamaha piano purchase." & vbCrLf _
		& "" & vbCrLf _
		& "Your registration for cashback has been received and will be processed within 30 days. If you did not upload a proof of purchase with the registration, please email it to promotions@gmx.yamaha.com with your name clearly stated. Once the registration has been verified, a cheque will be mailed to the individual registered." & vbCrLf _
		& "" & vbCrLf _
		& "Any enquiries regarding the cashback can be made via the dealer you purchased your instrument with, or by emailing promotions@gmx.yamaha.com." & vbCrLf _
		& "" & vbCrLf _
		& "We trust you will enjoy your new instrument for many years to come." & vbCrLf _		
		& "" & vbCrLf _
		& "Regards," & vbCrLf _
		& " " & vbCrLf _
