...
<head>
	...
	<style type="text/css" media="screen">@import "/yamahamusic.noborde rtables.css";</style>
...
<form name="formTeacher" action="<%= CONTROLLER %>" method="post">
	...
	<tr>
		...
		<th colspan="2" style="padding-top:10px;">New Class</th>
	</tr>
	<tr>
	...
	<tr>
		<td><label for="date">Date of commencement</label></td>
		<td colspan="3"><%
