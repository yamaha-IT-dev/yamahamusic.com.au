...
<form id="formToValidate" action="<%= CONTROLLER %>" method="post">
	...
	<div>
		<fieldset style="float:left;border-bottom:0px;">
			...
			<label class="required" for="creditflag">
				<span class="labelText">Payment Terms <span class="requiredMarker">(required)</span></span>

				<span>
					<input type="radio" name="creditflag" value="0"<%= WC._getClaimCreditflag()==0?" checked=\"checked\"":"" %> /> <strong>Cheque</strong> &nbsp;
					<input type="radio" name="creditflag" value="1"<%= WC._getClaimCreditflag()==1?" checked=\"checked\"":"" %> /> <strong>Credit</strong>
				</span>
			</label>
			...
			<label class="required" for="rctiflag">
				...
				<span>
					<input type="radio" name="rctiflag" id="rcti_0" value="0"<%= WC._getClaimRCTIflag()==0?" checked=\"checked\"":"" %> onclick="_setType();" /> <strong>Tax Invoice</strong> &nbsp;
					<input type="radio" name="rctiflag" id="rcti_1" value="1"<%= WC._getClaimRCTIflag()==1?" checked=\"checked\"":"" %> onclick="_setType();" /> <strong>RCTI</strong>
				</span>
			</label>
		...
		<fieldset style="float:left;padding-left:20px;border-bottom:0px;">
			...
			<label for="dateinvoice">
				<span class="labelText"><strong>Invoice Date</strong> <span class="requiredMarker">(required)</span></span>
			...
			<label for="datepurchased">
				<span class="labelText"><strong>Date Purchased</strong> <span class="requiredMarker">(required)</span></span>
			...
			<label for="datereceived">
				<span class="labelText"><strong>Date Received</strong> <span class="requiredMarker">(required)</span></span>
			<%
			...
			<label for="datecompleted">
				<span class="labelText"><strong>Date Completed</strong> <span class="requiredMarker">(required)</span></span>
			<%
	...
	<div style="background-color: #F0F1F3;">
		...
		<fieldset class="alt" style="float:left;">
			...
			<label class="required" for="modelnumber">
				<span class="labelText">Model Number <span class="requiredMarker">(required)</span></span>
			...
			<label class="required" for="serialnumber">
				<span class="labelText">Serial Number <span class="requiredMarker">(required)</span></span>
			...
			<label class="required" for="faultreport">
				<span class="labelText">Fault Report <span class="requiredMarker">(required - 30 characters max)</span></span>

				<textarea name="faultreport" id="faultreport" rows="2" style="width:230px;"><%= WC._getClaimFaultreport() %></textarea>
			</label>

			<label class="required" for="repairreport">
				<span class="labelText">Repair Report <span class="requiredMarker">(required - 50 characters max)</span></span>

				<textarea name="repairreport" id="repairreport" rows="2" style="width:230px;"><%= WC._getClaimRepairreport() %></textarea>
			</label>

			<label for="comment">
				<span class="labelText">Comment <br/>(50 characters max)</span>

				<textarea name="comment" id="comment" rows="2" style="width:230px;"><%= WC._getClaimComment() %></textarea>
			</label>
		...
		<fieldset class="alt" style="float:left;padding-left:20px;border-bottom:0px;">
			...
			<label class="required" for="labourcharge">
				<span class="labelText">Labour Charge<br/>(EX GST)<span class="requiredMarker">(required)</span></span>
			...
			<label class="required" for="partscharge">
				<span class="labelText">Parts Charge<br/>(EX GST)<span class="requiredMarker">(required)</span></span>
			...
			<label for="gstcharge">
				<span class="labelText"><strong>GST</strong><br/>(Calculated Automatically)</span>
	...
	<fieldset>
		...
		<label class="required" for="custname">
			<span class="labelText">Full Name <span class="requiredMarker">(required)</span></span>
			<input id="custname" name="custname" class="text" type="text"  value="<%= WC._getClaimCustname() %>" />
		</label>

		<label class="required" for="custaddress">

			<span class="labelText">Address <span class="requiredMarker">(required)</span></span>
			<textarea name="custaddress" id="custaddress" class="text" rows="2"><%= WC._getClaimCustaddress() %></textarea>
		</label>

		<label class="required" for="custsuburb">
			<span class="labelText">Suburb <span class="requiredMarker">(required)</span></span>
			<input id="custsuburb" name="custsuburb" class="text" type="text"  value="<%= WC._getClaimCustsuburb() %>" />
		</label>

		<label class="required" for="custstate">
			<span class="labelText">State <span class="requiredMarker">(required)</span></span>
		...
		<label class="required" for="custpostcode">
			<span class="labelText">Postcode <span class="requiredMarker">(required)</span></span>
		...
		<label for="custphone">
			...
			<input id="custphone" name="custphone" class="text" type="text" value="<%= WC._getClaimCustphone() %>" />
		</label>
