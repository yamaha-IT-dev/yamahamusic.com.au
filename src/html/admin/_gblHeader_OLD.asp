...
%>
			<li><a href="ctrlResource.asp">News / Information / Resources</a>		
			<ul>
...
%>
			<li><a href="ctrlServiceCentre.asp">Service / Support</a>
			<ul>
				...
				<li><a href="ctrlWarrantyClaim.asp">Warranty Claims</a></li>
