...
<head>
	<title>Yamaha Music Australia - Support - Service Centre Knowledge Base</title>
...
<%
	...
	if (rsAllResources && !rsAllResources.EOF) {
		while (!rsAllResources.EOF) {
			R._drawResourceItem(rsAllResources, "servicecentre.asp", intCategoryID);
...
%>
	<a href="servicecentre.asp">&lt;&lt; Service Centre Knowledge Base</a>
