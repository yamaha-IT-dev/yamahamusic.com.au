...
function ProductCategory() {
	...
	this._getAllProductCategoryExceptAV = _getAllProductCategoryExceptAV;
...
function _getAllProductCategoryExceptAV() {

	var strSQL = "SELECT product.id, product.parentid, yma_productcategory.name as parent, product.name FROM yma_productcategory AS product INNER JOIN yma_productcategory ON product.parentid = yma_productcategory.id WHERE product.parentid <> '1' ORDER BY yma_productcategory.name, product.name ASC";
