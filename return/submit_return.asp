...
Dim uploadsDirVar
uploadsDirVar = Server.MapPath("upload/" & intID & "/")
...
<table border="0" cellpadding="0" cellspacing="0" align="center" height="100%" class="main_content_table">
  ...
  <tr>
    <td class="content_column"><h2 align="center">Submit Goods Return (step 2)</h2>
    <p align="center"><img src="images/step2.jpg" border="0" /></p>
      <h3><strike>1. Fill in the Return details</strike></h3>      
      <form name="frmSend" method="POST" enctype="multipart/form-data" accept-charset="utf-8" action="submit_return.asp?id=<%=intID%>" onSubmit="return validateFormOnSubmit(this);">
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
          ...
          <tr>
            ...
            <td><%= session("test_performed") %></td>
          </tr>
          <tr>
            <td align="right"><strong>Accessories:</strong></td>
            <td><%
            if session("accessories") = 1 then
				response.Write("Yes")
			else
				response.Write("No")
			end if
          ...
          <tr>
            <td align="right" bgcolor="#FFFF00"><img src="images/forward_arrow.gif" border="0" /> <strong>Upload the receipt</strong>:</td>
      ...
      <p><img src="images/backward_arrow.gif" border="0" /> <a href="home.asp">Back to Home</a></p></td>
  </tr>
...
function SaveFiles
    ...
    if (UBound(ks) <> -1) then		
		...
		if err <> 0 then
			...
			response.Redirect("confirm_submit.asp")
		end if 
...
<head>
<title>Yamaha Goods Return Authority - Submit Return</title>
