...
sub main
	call validateLogin
	call getUserDetails(Session("yma_customerid"))
            ...
            <td valign="top" width="50%"><table cellpadding="5" cellspacing="0" class="form_box">
                ...
                <tr>
                  <td colspan="2">Reason for return<span class="mandatory">*</span>:<br />
                    <input type="text" id="txtReason" name="txtReason" maxlength="120" size="95" value="<%= session("new_reason") %>" required /></td>
                </tr>
                <tr>
                ...
                <tr rel="yes">
                  <td>If so, please specify when<span class="mandatory">*</span>:
                    ...
                    <em>DD/MM/YYYY</em></td>
                  <td>Serviced by:<br />
                    <input type="text" id="txtServicedBy" name="txtServicedBy" maxlength="20" size="20" value="<%= session("new_serviced_by") %>" /></td>
                </tr>
