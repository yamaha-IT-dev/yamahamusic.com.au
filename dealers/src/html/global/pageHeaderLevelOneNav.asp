...
<head>
	...
	<style type="text/css" media="screen">@import "/yamahamusic.nobordertables.css";</style>

<!--#include file="navigationStylesheet.asp" -->

</head>

<body>
<!--#include file="globalHeader.asp" -->
<!--#include file="globalOuterContentStart.asp" -->
	<div id="left">
		<!--#include file="navigationLeftShallow.asp" -->
	</div>
<!--#include file="globalMainContentStart.asp" -->