...
<%  if (M._getMessageItems().length > 0) { %>
          ...
          <p>You don't have to make this request <em>right now</em> you can <a href="default.asp">return to the homepage</a> and add more items if you wish. Unfortunately though, if you close your internet browser, your selection may be lost.</p>         
<%	} %>
        </fieldset>
      </form>
