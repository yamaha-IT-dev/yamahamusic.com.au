...
function listCategory() {
	...
	%><!--#include file="../src/html/adminCategoryList.asp"--><%
}
...
function newCategory() {
	...
	var C = new Category();
		...
		C._setCategoryDivision(_DIVISION);

	%><!--#include file="../src/html/adminCategoryEdit.asp"--><%
}
...
function saveCategory() {
	...
	var C = new Category();
		...
		C._setCategoryDivision(cleanForSQL(new String(Request("division"))));
