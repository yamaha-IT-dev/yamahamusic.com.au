      ...
      <form method="post" name="form_add_coop" id="form_add_coop" onsubmit="return validateFormOnSubmit(this)">        
        <table border="0" cellpadding="5" cellspacing="0" class="main_form_table">
          ...
          <tr>
            ...
            <td><input type="text" id="txtBudget" name="txtBudget" maxlength="80" size="80" required /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>
            <select name="cboPercentage" id="cboPercentage">
        ...
        <tr>
          ...
          <tr>
            ...
            <td><input type="checkbox" name="chkAdvertising" id="chkAdvertising" value="Print"> Print<br>
                            <input type="checkbox" name="chkAdvertising" id="chkAdvertising" value="Radio"> Radio<br>
                            <input type="checkbox" name="chkAdvertising" id="chkAdvertising" value="TV"> TV<br>
                            <input type="checkbox" name="chkAdvertising" id="chkAdvertising" value="Cinema"> Cinema<br>
                            <input type="checkbox" name="chkAdvertising" id="chkAdvertising" value="Online"> Online<br>
                            <input type="checkbox" name="chkAdvertising" id="chkAdvertising" value="Adwords"> Google Adwords
            </td>
          </tr>
          <tr>
            <td valign="top">Signage:</td>
            <td><input type="checkbox" name="chkSignage" id="chkSignage" value="Outdoor"> Outdoor<br>
                <input type="checkbox" name="chkSignage" id="chkSignage" value="Indoor"> Indoor<br>
                <input type="checkbox" name="chkSignage" id="chkSignage" value="Front Window"> Front Window
            </td>
          </tr>
          <tr>
            <td valign="top">Promotional materials:</td>
            <td><input type="checkbox" name="chkPromotionalMaterial" id="chkPromotionalMaterial" value="Direct Mail"> Direct Mail<br>
                <input type="checkbox" name="chkPromotionalMaterial" id="chkPromotionalMaterial" value="Catalogues"> Catalogues<br>
                <input type="checkbox" name="chkPromotionalMaterial" id="chkPromotionalMaterial" value="Flyers"> Flyers<br>
                <input type="checkbox" name="chkPromotionalMaterial" id="chkPromotionalMaterial" value="Posters"> Posters<br>
                <input type="checkbox" name="chkPromotionalMaterial" id="chkPromotionalMaterial" value="Merchandise"> Merchandise<br>
                <input type="checkbox" name="chkPromotionalMaterial" id="chkPromotionalMaterial" value="Tshirts"> Tshirts</td>
          </tr>
          <tr>
            <td>Event:</td>
