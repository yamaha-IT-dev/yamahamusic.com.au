...
sub main
	...
	if Request.ServerVariables("REQUEST_METHOD") = "POST" then
		...
		coopBudget 				= Server.HTMLEncode(Replace(Trim(Request("txtBudget")),"'","''"))
		coopExclusive 			= Server.HTMLEncode(Trim(Request("cboExclusive")))
		coopPercentage 			= Server.HTMLEncode(Trim(Request("cboPercentage")))
		coopStockAvailability  	= Server.HTMLEncode(Trim(Request("cboStockAvailability")))
		coopAdvertising 		= Server.HTMLEncode(Trim(Request("chkAdvertising")))
		coopSignage 			= Server.HTMLEncode(Trim(Request("chkSignage")))
		coopPromotionalMaterial = Server.HTMLEncode(Trim(Request("chkPromotionalMaterial")))
		coopEvent 			    = Server.HTMLEncode(Trim(Request("cboEvent")))
		coopOutlet 				= Server.HTMLEncode(Replace(Trim(Request("txtOutlet")),"'","''"))
		coopAdSize 				= Server.HTMLEncode(Replace(Trim(Request("txtAdSize")),"'","''"))
		coopNoPlacement 		= Server.HTMLEncode(Replace(Trim(Request("txtNoPlacement")),"'","''"))
		...
		coopSignagePlacement 	= Server.HTMLEncode(Replace(Trim(Request("txtSignagePlacement")),"'","''"))
		coopSignageDescription 	= Server.HTMLEncode(Replace(Trim(Request("txtSignageDescription")),"'","''"))
		...
		coopMaterialDescription = Server.HTMLEncode(Replace(Trim(Request("txtMaterialDescription")),"'","''"))
		coopMaterialSize 		= Server.HTMLEncode(Replace(Trim(Request("txtMaterialSize")),"'","''"))
		coopMaterialNoPage 		= Server.HTMLEncode(Replace(Trim(Request("txtMaterialNoPage")),"'","''"))
		coopMaterialQty 		= Server.HTMLEncode(Replace(Trim(Request("txtMaterialQty")),"'","''"))
		coopMaterialDistribute 	= Server.HTMLEncode(Replace(Trim(Request("txtMaterialDistribute")),"'","''"))
		...
		coopEventOutline 		= Server.HTMLEncode(Replace(Trim(Request("txtEventOutline")),"'","''"))
		coopVenue 				= Server.HTMLEncode(Replace(Trim(Request("txtVenue")),"'","''"))
		coopEventDate 			= Server.HTMLEncode(Trim(Request("txtEventDate")))
		coopNoAttendee 			= Server.HTMLEncode(Replace(Trim(Request("txtNoAttendee")),"'","''"))
		...
		coopCreatedBy 			= Trim(Session("yma_userid"))
		
		if trim(request("action")) = "add" then			
			call addCoop(coopName, coopBudget, coopExclusive, coopPercentage, coopStockAvailability, coopAdvertising, coopSignage, coopPromotionalMaterial, coopEvent, coopOutlet, coopAdSize, coopNoPlacement, coopDatePlacement, coopMediaSupplier, coopMediaArtwork, coopArtworkDeadline, coopSignagePlacement, coopSignageDescription, coopSignageSupplier, coopSignageArtwork, coopDateInstallation, coopMaterialDescription, coopMaterialSize, coopMaterialNoPage, coopMaterialQty, coopMaterialDistribute, coopMaterialSupplier, coopMaterialArtwork, coopMaterialDeadline, coopEventOutline, coopVenue, coopEventDate, coopNoAttendee, coopMarketingSupport, coopYamahaArtist, coopCreatedBy)
		end if
	end if	
end sub
    ...
    <td class="main_content"><ol class="breadcrumb">
      ...
      <form method="post" name="form_add_coop" id="form_add_coop" onsubmit="return validateFormOnSubmit(this)">
        <table border="0" cellpadding="5" cellspacing="0" class="main_form_table">
          ...
          <tr>
            <td>Qty:</td>
            <td><input type="text" id="txtMaterialQty" name="txtMaterialQty" maxlength="6" size="4"  /></td>
          </tr>
          <tr>
